...
GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#I2C 1#I2C 1#UART\
...
0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#USB Reset#GPIO#GPIO#GPIO#ENET\
Reset#Enet 0#Enet 0} \
   CONFIG.PCW_MIO_TREE_SIGNALS {\
gpio[0]#gpio[1]#gpio[2]#gpio[3]#gpio[4]#gpio[5]#gpio[6]#gpio[7]#gpio[8]#gpio[9]#gpio[10]#gpio[11]#scl#sda#rx#tx#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#cd#reset#gpio[48]#gpio[49]#gpio[50]#reset#mdc#mdio} \
   ...
   CONFIG.PCW_UIPARAM_DDR_T_FAW {33} \
   CONFIG.PCW_UIPARAM_DDR_T_RAS_MIN {32} \
   CONFIG.PCW_UIPARAM_DDR_T_RC {45} \
   CONFIG.PCW_UIPARAM_DDR_T_RCD {13} \
   CONFIG.PCW_UIPARAM_DDR_T_RP {13} \
